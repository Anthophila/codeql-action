...
function createdDBForScannedLanguages(codeqlCmd, databaseFolder) {
...
function finalizeDatabaseCreation(codeqlCmd, databaseFolder) {
    return __awaiter(this, void 0, void 0, function* () {
        yield createdDBForScannedLanguages(codeqlCmd, databaseFolder);
...
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            yield externalQueries.CheckoutExternalQueries(config);

...
function anyFilesAlreadyUploaded(sarifFiles) {
    return __awaiter(this, void 0, void 0, function* () {
...
function upload(input) {
    return __awaiter(this, void 0, void 0, function* () {
        if (fs.lstatSync(input).isDirectory()) {
            ...
            yield upload_files(sarifFiles);
        }
        else {
            yield upload_files([input]);
        }
    });
}
exports.upload = upload;
// Uploads the given set of sarif files.
function upload_files(sarifFiles) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            if (yield anyFilesAlreadyUploaded(sarifFiles)) {
            ...
            if (res.message.statusCode === 500) {
                ...
                core.error('Upload failed (' + requestID + '): ' + (yield res.readBody()));
            }
            else if (res.message.statusCode !== 202) {
                core.setFailed('Upload failed (' + requestID + '): ' + (yield res.readBody()));
            }
            else {
            ...
            for (let sarifFile of sarifFiles) {
                fs.writeFileSync(yield getSentinelFilePath(sarifFile), '');
            }
        }
        catch (error) {

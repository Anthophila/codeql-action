 ...
 */
function createStatusReport(actionName, status, startedAt, languages, cause, exception) {
...
function reportActionStarting(action) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (action === 'init') {
            ...
            languages = yield writeAnalysedLanguages();
        }
        else {
...
function reportActionFailed(action, cause, exception) {
    return __awaiter(this, void 0, void 0, function* () {
        yield sendStatusReport(createStatusReport(action, 'failure', readInitStartedDate(), readAnalysedLanguages(), cause, exception));
    });
}
...
function reportActionSucceeded(action) {
    return __awaiter(this, void 0, void 0, function* () {
        yield sendStatusReport(createStatusReport(action, 'success', readInitStartedDate(), readAnalysedLanguages()));
    });
}

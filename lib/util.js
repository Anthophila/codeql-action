 ...
 */
function createStatusReport(actionName, status, startedAt, cause, exception) {
    return __awaiter(this, void 0, void 0, function* () {
...
function reportActionStarting(action) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const statusReport = yield createStatusReport(action, 'starting', startedAt);
        if (!statusReport) {
            return false;
        }
...
function reportActionFailed(action, cause, exception) {
    return __awaiter(this, void 0, void 0, function* () {
        const languages = (yield getLanguages()).sort().join(',');
        yield sendStatusReport(yield createStatusReport(action, 'failure', readInitStartedDate(), cause, exception));
    });
}
...
function reportActionSucceeded(action) {
    return __awaiter(this, void 0, void 0, function* () {
        const languages = (yield getLanguages()).sort().join(',');
        yield sendStatusReport(yield createStatusReport(action, 'success', readInitStartedDate()));
    });
}
